...
void EyeTransition::Apply(float t) {
  Origin->OffsetX             = Origin->OffsetX             * (1.0f - t) + Destin.OffsetX             * t;
  Origin->OffsetY             = Origin->OffsetY             * (1.0f - t) + Destin.OffsetY             * t;
  ...
  Origin->Inverse_Radius_Top  = Origin->Inverse_Radius_Top  * (1.0f - t) + Destin.Inverse_Radius_Top  * t;
  Origin->Inverse_Radius_Bottom = Origin->Inverse_Radius_Bottom * (1.0f - t) + Destin.Inverse_Radius_Bottom * t;
  Origin->Inverse_Offset_Top  = Origin->Inverse_Offset_Top  * (1.0f - t) + Destin.Inverse_Offset_Top  * t;
  Origin->Inverse_Offset_Bottom = Origin->Inverse_Offset_Bottom * (1.0f - t) + Destin.Inverse_Offset_Bottom * t;
}
